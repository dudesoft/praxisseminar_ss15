define(function() {
    var MediaPlayerFactory = {
        ...
        getAudioPlayer: function(src) {
            return "<div id='lightbox_content'><div id='audio_container'><audio controls><source src='" + src + "' type='audio/mp3'>Your browser does not support the audio tag.</audio></div></div>";
        },
        getPictureGallery: function(src) {
            return "<div id='lightbox_content'><div id='audio_container'><img src='" + src + "' ></img></div></div>";
        }
    };
