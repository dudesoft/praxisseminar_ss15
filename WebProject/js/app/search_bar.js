define(['jquery', './db_connector', 'bootstrap', 'jquery_ui'], function($, db_connector) {
    var SearchBar = {
        setupSearchBar: function(src) {
            //Database requests
            db_connector.getAllJourneys(this.setupJourneyDropdown);
            db_connector.getAllDates(this.setupDatepicker);
            db_connector.getAutocompleteData(this.setupAutocomplete);

            //clicklisteners to start search
            $('#search-button, #enter_search').click(function() {
                SearchBar.buildSearchURL();
            });
        ...
        setupAutocomplete: function(data) {
        ...
        setupJourneyDropdown: function(data) {
        ...
        buildSearchURL: function() {
            ...
            //Build strings for search url out of Search parameters
